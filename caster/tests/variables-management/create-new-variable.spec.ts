...
test.describe('Variables Management', () => {
  test('Create New Variable', async ({ casterAuthenticatedPage: page, cleanupCasterProject }) => {
    const projectName = 'Var Create Project';
    const directoryName = 'Var Create Dir';
