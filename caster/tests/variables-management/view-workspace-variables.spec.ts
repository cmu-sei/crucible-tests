...
test.describe('Variables Management', () => {
  test('View Workspace Variables', async ({ casterAuthenticatedPage: page, cleanupCasterProject }) => {
    const projectName = 'Var View Project';
    const directoryName = 'Var View Dir';
