...
test.describe('Variables Management', () => {
  test('Create Sensitive Variable', async ({ casterAuthenticatedPage: page, cleanupCasterProject }) => {
    const projectName = 'Sensitive Var Project';
    const directoryName = 'Sensitive Var Dir';
