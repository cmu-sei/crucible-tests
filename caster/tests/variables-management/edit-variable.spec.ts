...
test.describe('Variables Management', () => {
  test('Edit Variable', async ({ casterAuthenticatedPage: page, cleanupCasterProject }) => {
    const projectName = 'Var Edit Project';
    const directoryName = 'Var Edit Dir';
